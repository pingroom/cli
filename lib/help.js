...
Commands:
  ...
  reconnect Replace this machine's saved connection with a fresh approval
...
export const COMMAND_HELP_SECTIONS = {
  ...
  reconnect: `reconnect:
  pingroom reconnect                Replace this CLI's saved connection with a
                                    fresh app-approved credential, then revoke
                                    the old one. Your existing connection keeps
